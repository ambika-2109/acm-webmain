...
<nav className="navbar navbar-expand-lg navbar-light bg-light">
  <div className="container">
    ...
    <img src="./image/logo.png"  alt="" width="250" height="100" className="d-inline-block align-text-top img-fluid" />
    </NavLink>
    ...
    <div className= {`collapse navbar-collapse ${show ? "show" : ""}`} >
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <NavLink className="nav-link active" aria-current="page" to="/">Overview</NavLink>
        </li>
        <li className="nav-item">
      ...
      <form className="d-flex">
        ...
        <button className="btn btn-style btn-style-border" type="submit">Register</button>
      </form>
    </div>
  </div>
</nav>
